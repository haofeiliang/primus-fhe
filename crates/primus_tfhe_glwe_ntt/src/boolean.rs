...
pub type BooleanEncryptor<'a, T> =
    primus_fhe_core::tfhe::BooleanEncryptor<'a, T, BarrettModulus<T>, BarrettModulus<T>>;

/// Boolean decryptor for the explicit-modulus NTT backend.
pub type BooleanDecryptor<'a, T> =
    primus_fhe_core::tfhe::BooleanDecryptor<'a, T, BarrettModulus<T>, BarrettModulus<T>>;
