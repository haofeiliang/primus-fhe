...
use crate::{
    ...
    NttGlweBootstrappingKey, SparseGlweBootstrappingKey, TfheContext, TfheParameters,
};
    ...
    Table: MonomialNttTable<ValueT = T>,
{
    ...
    /// requirements; ordinary PBS correctness alone does not establish sufficient
    /// margin at the smallest output gadget scale.
