...
Moduli, multiplier 17, input sequence and lengths match the explicit-modulus cases in `primus_modulus/benches/slice_arithmetic.rs`. Lengths 1024/4096 measure polynomial-sized buffers; 1025 includes a SIMD tail. Compare the corresponding broadcast scalar and factor operations to assess precomputation benefits. Factor construction is outside timing, so this does not measure its break-even reuse count. Repeated in-place results remain canonical without copying/reset.
