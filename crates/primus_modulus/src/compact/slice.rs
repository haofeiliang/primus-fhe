...
mod scalar {
    ...
    use crate::{CompactModulus, common::compact::slice};

    impl<T: FheUint> ReduceOnceSlice<T> for CompactModulus<T> {
        #[inline]
    ...
    impl<T: FheUint> ReduceNegSlice<T> for CompactModulus<T> {
        #[inline]
    ...
    impl<T: FheUint> ReduceAddSlice<T> for CompactModulus<T> {
        #[inline]
    ...
    impl<T: FheUint> ReduceSubSlice<T> for CompactModulus<T> {
        #[inline]
    ...
    impl<T: FheUint> ReduceDoubleSlice<T> for CompactModulus<T> {
        #[inline]
...
mod simd {
    ...
    use crate::{CompactModulus, common::compact::simd};
