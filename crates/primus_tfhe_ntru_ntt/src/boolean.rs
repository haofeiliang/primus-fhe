...
pub type BooleanDecryptor<'a, T> = primus_tfhe_ntru::BooleanDecryptor<'a, T, BarrettModulus<T>>;
...
pub type BooleanEvaluator<'a, T, Table> =
    primus_tfhe::BooleanEvaluator<T, BarrettModulus<T>, Evaluator<'a, T, Table>>;
