...
#[inline]
pub(super) fn t2_load_xy(block: &[u64; 8]) -> (__m256i, __m256i) {
...
#[target_feature(enable = "avx2")]
#[inline]
pub(super) fn t2_store_xy(v_x: __m256i, v_y: __m256i, block: &mut [u64; 8]) {
...
#[target_feature(enable = "avx2")]
#[inline]
pub(super) fn t1_load_xy(block: &[u64; 8]) -> (__m256i, __m256i) {
    let ptr = block.as_ptr().cast::<__m256i>();
...
#[target_feature(enable = "avx2")]
#[inline]
pub(super) fn t1_store_xy(v_x: __m256i, v_y: __m256i, block: &mut [u64; 8]) {
