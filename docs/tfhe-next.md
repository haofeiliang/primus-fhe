...
- Fourier GLWE CBS 的 B1.1–B1.3 已完成，误差、成本与示例见 [CBS 专项](tfhe-cbs.md)。B1.4–B1.6 已提供四后端具名参数、自动建表、密钥绑定与 CBS 消费接口；继续 B1.7 集成与成本验收，再由 B2 接入 NTRU Boolean，见[后端补齐计划](tfhe-backend-plan.md)。
