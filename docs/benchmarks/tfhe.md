...
| `primus_ntru / ternary_cmux` | u32/u64、N=1024 的 NTT / 两种 FFT ternary 融合单步与两次 binary CMUX；[误差、时间与 scratch](../tfhe-ntru-ternary.md#5-b72ntt-ngsw-ternary-融合单步) |
...
| `primus_tfhe_ntru_fourier / sparse_pbs` | n/h/N=728/33/1024、两种 FFT、u32/u64，同一奇数重量客户端的经典/稀疏普通/三输出与 server keygen；[B8.3 误差/成本](../tfhe-ntru-sparse.md#8-b83-fourier-接入与独立验收)、[CSV](tfhe-b8.3.csv) |
